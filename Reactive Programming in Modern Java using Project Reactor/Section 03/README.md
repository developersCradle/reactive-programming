...
<img src="traditionalProgramming.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="700"/>
...
<img src="whatHasChanged.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="600"/>

1. This was not case 15years ago!

<img src="RestAPI.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="600"/>
...
<img src="threadsInGeneral.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="600"/>

- For this reason servers comes with fixed size of **thread pool**.

<img src="RestAPI2.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="600"/>
...
<img src="Callbacks.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="600"/>

- Summary: Callbacks have more **minuses** than **plusses**, for todays needs.

<img src="future.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="600"/>
...
<img src="flowAPI.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="600"/>

<br>

<img src="summary.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="600"/>
...
<img src="reactiveProgramming.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="500"/>
...
<img src="reactiveProgrammingExample.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="500"/>
...
<img src="backpressure.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="500"/>
...
<img src="modelsChanges.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="500"/>

1. With **Backpressure** reactive programming is called **Push-Pull based data flow model**.

<img src="whenUsingReactiveProgramming.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="500"/>

<br>d

<img src="reactiveAppArhitecture.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="650"/>
...
<img src="reactiveStreams.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="650"/>
...
<img src="publisher.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="650"/>
...
<img src="subscription.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="600"/>
...
<img src="reactiveStreamsHowItsWorks.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="600"/>
...
<img src="reactiveStreamsHowItsWorksIfNotWorks.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="600"/>
...
<img src="processor.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="600"/>
