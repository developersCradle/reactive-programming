...
<img src="flux.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="700"/>

1. Operation layer. Common operations are `map()` and `filter()`.
2. Error occurred.

 <img src="mono.PNG" Build Reactive MicroServices using Spring WebFlux/SpringBoot width="700"/>
